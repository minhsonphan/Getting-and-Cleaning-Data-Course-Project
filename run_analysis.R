...
write.table(dt_body_acc_final, file = "./Data/Tidy Dataset/triaxial_body_acceleration.csv", sep = ",")
...
write.table(dt_body_gyro_final, file = "./Data/Tidy Dataset/triaxial_body_gyro.csv", sep = ",")
...
write.table(dt_total_acc_final, file = "./Data/Tidy Dataset/triaxial_total_acc.csv", sep = ",")
...
write.table(dt_measurement, file = "./Data/Tidy Dataset/measurement.csv", sep = ",")
...
write.table(dt_measurement_mean2, file = "./Data/Tidy Dataset/measurement_mean.csv", sep = ",")
